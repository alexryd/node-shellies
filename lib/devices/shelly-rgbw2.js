...
class ShellyRGBW2 extends Device {
  constructor(id, host, mode = 'color') {
    ...
    this._mapMqttTopics({
      switch: 'color/0/status.ison',
      red: 'color/0/status.red',
      green: 'color/0/status.green',
      blue: 'color/0/status.blue',
      white: 'color/0/status.white',
      gain: 'color/0/status.gain',

      switch0: 'white/0/status.ison',
      brightness0: 'white/0/status.brightness',
      switch1: 'white/1/status.ison',
      brightness1: 'white/1/status.brightness',
      switch2: 'white/2/status.ison',
      brightness2: 'white/2/status.brightness',
      switch3: 'white/3/status.ison',
      brightness3: 'white/3/status.brightness',

      power0: ['color/0/power', 'white/0/power'],
      energyCounter0: ['color/0/energy', 'white/0/energy'],
      power1: 'white/1/power',
      energyCounter1: 'white/1/energy',
      power2: 'white/2/power',
      energyCounter2: 'white/2/energy',
      power3: 'white/3/power',
      energyCounter3: 'white/3/energy',
