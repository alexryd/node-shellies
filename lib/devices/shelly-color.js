...
class ShellyColor extends Device {
  constructor(id, host) {
    super(id, host)
    ...
    this._mapMqttTopics({
      ...
      brightness: 'color/0/status.brightness',
      colorTemperature: 'color/0/status.temp',

      mode: 'color/0/status.mode',
    })
  }
...
ShellyColor.deviceType = 'SHCL-255'
ShellyColor.deviceName = 'Shelly Color'

module.exports = ShellyColor
